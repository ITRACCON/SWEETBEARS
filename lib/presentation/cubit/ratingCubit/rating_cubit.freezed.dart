...
mixin _$RatingState {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(List<User> users) initial,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(List<User> users)? initial,
...
class __$$IntialImplCopyWithImpl<$Res>
    extends _$RatingStateCopyWithImpl<$Res, _$IntialImpl>
...
class _$IntialImpl implements Intial {
  const _$IntialImpl(final List<User> users) : _users = users;
  ...
  @override
  String toString() {
    return 'RatingState.initial(users: $users)';
  }
...
abstract class Intial implements RatingState {
  const factory Intial(final List<User> users) = _$IntialImpl;
